Contributing to Frozen Core
============================

The Frozen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Frozen Core project, and is not to be
confused with overall Frozen Network Protocol consensus changes.

Whether a pull request is merged into Frozen Core rests with the project merge
...
Patches that change Frozen consensus rules are considerably more involved than
...
Where a patch set proposes to change the Frozen consensus, it must have been
...
The project leader is the release manager for each Frozen Core release.
