...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1523526886, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 9904;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Frozen starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Frozen: 1 minute
        nTargetSpacing = 1 * 60;  // Frozen: 1 minute
        nLastPOWBlock = 14400;
        nMaturity = 60;
        nModifierUpdateBlock = 1;
	

	const char* pszTimestamp = "Frozen / Time to break the ICE!";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1523526886;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 30147;
        ...
        vSeeds.push_back(CDNSSeedData("45.32.144.174","45.77.63.44"));
 	vSeeds.push_back(CDNSSeedData("140.82.55.100","45.77.63.44"));	
        ...
        strObfuscationPoolDummyAddress = "FNNdvBMxTKQ3ZzBNy193SbipQb7NrcVuYj";
        nStartMasternodePayments = 1523526886; 
    }
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 9906;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Frozen: 1 day
        nTargetSpacing = 1 * 60;  // Frozen: 1 minute
        nLastPOWBlock = 20000;
        nMaturity = 60;
        //! Modify the testnet genesis block so the timestamp is valid for a later start.
        genesis.nTime = 1523526886;
        genesis.nNonce = 73814;
        hashGenesisBlock = genesis.GetHash();
        //assert(hashGenesisBlock == uint256("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("", ""));
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 107); // Testnet frozen addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet frozen script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 142);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet frozen BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet frozen BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet frozen BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Frozen: 1 day
        nTargetSpacing = 1 * 60;        // Frozen: 1 minutes
