                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Frozen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and frozen: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Frozen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Frozen Core"));
    ...
    openAction->setStatusTip(tr("Open a Frozen: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Frozen Core help message to get a list with possible Frozen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Frozen Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Frozen Core"); // default title
