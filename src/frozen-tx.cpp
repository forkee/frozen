...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Frozen Core frozen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  frozen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded frozen transaction") + "\n" +
                               "  frozen-tx [options] -create [commands]   " + _("Create hex-encoded frozen transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded frozen transaction
