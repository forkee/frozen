...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
    ...
    CAmount nSubsidy = 0;
    if (nHeight <= 1440 && nHeight > 0) {
        nSubsidy = 0 * COIN;
    } else if (nHeight <= 14400 && nHeight >= 1440) {
        nSubsidy = 100 * COIN;
    } else if (nHeight <= 43200 && nHeight >= 14400) {
        nSubsidy = 80 * COIN;
    } else if (nHeight <= 129600 && nHeight >= 43200) {
        nSubsidy = 60 * COIN;
    } else if (nHeight <= 388800 && nHeight >= 129600) {
        nSubsidy = 40 * COIN;
    } else if (nHeight <= 777600 && nHeight >= 388800) {
        nSubsidy = 20 * COIN;
        ...
        nSubsidy = 0 * COIN;
		     ...
		     return (nSubsidy*80 / 100) * 1440 * 30;  
}
