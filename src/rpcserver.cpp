...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Frozen features */
        {"frozen", "masternode", &masternode, true, true, false},
        {"frozen", "masternodelist", &masternodelist, true, true, false},
        {"frozen", "mnbudget", &mnbudget, true, true, false},
        {"frozen", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"frozen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"frozen", "mnsync", &mnsync, true, true, false},
        {"frozen", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"frozen", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use frozend, or the -server option to frozen-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> frozen-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9905/\n";
}
