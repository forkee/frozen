...
In order to support loading of multiple wallets in frozen-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is frozen.cpp.
...
Changes to frozen.cpp
----------------------
frozen.cpp is the entry point into frozen-qt, and as such, will require some minor modifications to provide hooks for
