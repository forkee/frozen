Frozen Core version 2.2.1 is now available from:

  <https://github.com/frozen-project/frozen/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/frozen-project/frozen/issues>

Compatibility
==============

Frozen Core is extensively tested on multiple operating systems using
...
Frozen Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Frozen was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/frozen-project-translations/).
