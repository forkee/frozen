...
RESOURCES += src/qt/frozen.qrc src/qt/frozen_locale.qrc

TRANSLATIONS += src/qt/locale/frozen_bg.ts \
                src/qt/locale/frozen_de.ts \
                src/qt/locale/frozen_en.ts \
                src/qt/locale/frozen_es.ts \
                src/qt/locale/frozen_fi.ts \
                src/qt/locale/frozen_fr.ts \
                src/qt/locale/frozen_it.ts \
                src/qt/locale/frozen_ja.ts \
                src/qt/locale/frozen_pl.ts \
                src/qt/locale/frozen_pt.ts \
                src/qt/locale/frozen_ru.ts \
                src/qt/locale/frozen_sk.ts \
                src/qt/locale/frozen_sv.ts \
                src/qt/locale/frozen_vi.ts \
                src/qt/locale/frozen_zh_CN.ts \
                src/qt/locale/frozen_zh_TW.ts
